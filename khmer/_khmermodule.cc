...
static
PyObject *
hash_output_fasta_kmer_pos_freq(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;
...
static
PyObject *
count_find_spectral_error_positions(khmer_KCountingHash_Object * me, PyObject * args)
{
...
static
PyObject *
hash_fasta_count_kmers_by_position(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;
...
static
PyObject *
hash_fasta_dump_kmers_by_abundance(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;
...
static
PyObject *
hash_collect_high_abundance_kmers(khmer_KCountingHash_Object * me, PyObject * args);
...
static
PyObject *
hash_find_all_tags_truncate_on_abundance(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;
...
static
PyObject *
hash_do_subset_partition_with_abundance(khmer_KCountingHash_Object * me, PyObject * args)
{
    CountingHash * counting = me->counting;
...
static PyObject * hash_collect_high_abundance_kmers(khmer_KCountingHash_Object * me , PyObject * args)
{
    CountingHash * counting = me->counting;
...
init_khmer(void)
{
    ...
    if (PyModule_AddObject( m, "CountingHash", (PyObject *)&khmer_KCountingHash_Type ) < 0) {
        return;
    }
